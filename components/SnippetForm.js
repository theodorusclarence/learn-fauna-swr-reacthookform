...
export default function SnippetForm({ snippet }) {
    ...
    return (
        ...
        <form onSubmit={handleSubmit(snippet ? updateSnippet : createSnippet)}>
            <div className='mb-4'>
                <label className='block text-red-100 text-sm font-bold mb-1' htmlFor='name'>
                    Name
                </label>
                <input
                    type='text'
            ...
            <div className='mb-4'>
                <label className='block text-red-100 text-sm font-bold mb-1' htmlFor='language'>
                    Language
                </label>
                <select
                    id='language'
                ...
                {errors.language && <p className='font-bold text-red-900'>Language is required</p>}
            </div>
            <div className='mb-4'>
                <label className='block text-red-100 text-sm font-bold mb-1' htmlFor='description'>
                    Description
                </label>
                <textarea
                    name='description'
            ...
            <div className='mb-4'>
                <label className='block text-red-100 text-sm font-bold mb-1' htmlFor='code'>
                    Code
                </label>
                <textarea
                    name='code'
                    ...
                    ref={register({ required: true })}
                ></textarea>
                {errors.code && <p className='font-bold text-red-900'>Code is required</p>}
            </div>
            <button
